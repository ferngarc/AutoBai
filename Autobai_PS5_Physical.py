...
class PS5Bot:
    ...
    def add_ps5_to_cart_and_checkout(self):
        ...
        checkOut = (
            '//*[@id="cart-root-container-content-skip"]/div[1]/div/div[2]/div/div/div/div/'
            "div[3]/div/div/div[2]/div/div[2]/div/button[1]"
        )
        continueWithoutAccount = (
            "/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[1]"
    ...
    def filling_shipping_info(self):
        firstContinue = (
            "/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[2]/div/div[2]/"
        ...
        phone = '//*[@id="phone"]'
        confirmInfo = (
            "/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[3]/div[1]/div[2]/"
    ...
    def fill_out_payment_and_order(self):  # FILLS OUT PAYMENT
        ...
        creditCVV = '//*[@id="cvv"]'
        reviewOrder = (
            "/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[4]/div[1]/div[2]/div/div"
